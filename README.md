...
| Platform | File |
|----------|------|
| Windows | [DungeonInTheSky-Windows.zip]([[https://github.com/yourusername/dungeon-in-the-sky/releases/download/v1.0.0/DungeonInTheSky-Windows.zip](https://github.com/ecruzmango/Dungeon_sky/releases/download/v1.0.1/Dungeon.in.the.Sky.Windows.zip)](https://github.com/ecruzmango/Dungeons_in_the_Sky/releases/download/v1.0.1/Dungeon.in.the.Sky.Windows.zip)) |
